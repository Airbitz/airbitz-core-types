...
export type AbcCurrencyWallet = {
  ...
  getMaxSpendable(AbcSpendInfo): Promise<string>,
  getReceiveAddress(currencyCode?: string): Promise<AbcReceiveAddress>,
  getTransactions({[currencyCode: string]: string}): Promise<Array<AbcTransaction>>,
  enableTokens(tokenCodes: Array<string>): any,
  encodeUri(AbcParsedUri): string,
  keys(): any,
  localFolder(): DiskletFolder,
  lockReceiveAddress(): any,
  makeAddressQrCode(): any,
  makeSpend(AbcSpendInfo): Promise<AbcTransaction>,
  ...
  saveTx(AbcTransaction): Promise<AbcTransaction>,
  saveTxMetadata(txId: string, currencyCode: string, AbcMetadata): any,
  signBroadCastAndSave(AbcSpendInfo): Promise<any>,
  signTx(AbcTransaction): Promise<AbcTransaction>,
  startEngine(): any,
  stopEngine(): any,
